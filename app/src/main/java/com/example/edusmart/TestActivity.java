...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView it = findViewById(R.id.cardRTIT);
        it.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(TestActivity.this,TestDetailsActivity.class);
                //it.putExtra("title", "IT");
                startActivity(it);
            }
        });

        CardView pharmacy = findViewById(R.id.cardRTPharmacy);
        ...
        CardView international_relations = findViewById(R.id.cardRTInternationalRelations);
        ...
        CardView journalism = findViewById(R.id.cardRTJournalism);
        ...
        CardView psychology = findViewById(R.id.cardRTPsychology);
        ...
        CardView engineering = findViewById(R.id.cardRTEngineering);
